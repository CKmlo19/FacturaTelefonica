...
/****** Object:  Table [dbo].[TipoElemento]    Script Date: 6/6/2024 03:03:51 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[TipoElemento]  WITH CHECK ADD  CONSTRAINT [FK_TipoElemento_TipoUnidad] FOREIGN KEY([IdTipoUnidad])
